...
Need assistance with Symplr? Our support team is here to help you resolve issues and keep your work moving forward.
...
When an error occurs, you will see a **“Contact Support”** option within the message, allowing you to report the issue instantly:

<Frame>
  ![Image](/images/image-43.png)
</Frame>

In this example, the error message includes a **“Contact Support”** button, allowing you to submit the issue directly from the application.
...
When contacting support via chat or email, providing the following information helps ensure faster resolution:
...
<Note>
  ...
  If you are facing a critical issue, we recommend using in-app support for faster assistance.
</Note>
