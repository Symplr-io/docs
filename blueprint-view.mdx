...
Navigation paths display how users move between screens based on configured actions such as button presses and interactions.
...
The storyboard options allow additional application elements to be connected to the selected screen.
...
### Add Decisions and Workflows

Blueprint View also supports connecting Decisions and Workflows to extend application logic and behavior.

- **Decision** — Adds branching logic and conditional flow paths
- **Workflow** — Connects reusable workflows and API-related processes

These connections help extend application functionality directly from the blueprint structure.

## Manage Screens

Additional screen management actions are available from the three-dot menu on each screen card.
...
<Frame>
  ![14 Works Space Control](/images/14-works-space-control.jpg)
</Frame>
