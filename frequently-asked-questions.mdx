...
<AccordionGroup>
  ...
  <Accordion title="Can I access my projects later?">
    ...
    **Steps:**
    ...
    2. Locate the **“Your Apps”** section, where all your created projects are listed
    3. Browse through the list to find your project
    4. Click on the project name/Open button to open and continue working on it You can also use the **search bar** to quickly find a specific project by entering its name.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="How do I contact support?">
    ...
    - **Report issues directly from the application** When an error occurs, click the **“Contact Support”** button displayed with the error message to submit the issue instantly.
