...
<AccordionGroup>
  ...
  <Accordion title="Can I run the application without downloading the code?">
    ...
    **Options:**
    ...
    These options allow you to validate your application quickly before downloading or deploying the code. to refer the steps click [here](https://docs.101studio.co/caffd#build-&-run-your-application-instantly)
  </Accordion>
</AccordionGroup>
