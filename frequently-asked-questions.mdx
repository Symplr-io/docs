...
<AccordionGroup>
  ...
  <Accordion title="How can I find my existing projects in Symplr?">
    ...
    **Follow the Below Steps:**
    ...
    4. Click on the project name/Open button to open and continue working on it \
       \
       You can also use the **search bar** to quickly find a specific project by entering its name.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="How can I generate an application in Symplr?">
    ...
    - **Import a Figma File URL** \
      Provide a Figma file link to automatically convert your design into application screens and navigation.\
      \\
    - **Use AI Prompts** \
      Describe your application using prompts, and Symplr will generate the screens and structure based on your input.
  </Accordion>
  ...
  <Accordion title="Which method should I use — Figma import or AI prompt?">
    ...
    - **Use Figma import** \
      If you already have a Figma design, this option allows you to convert your existing UI screens into a functional application.\
      \\
    - **Use AI prompts** \
      If you don’t have a design, you can describe your application using prompts, and Symplr will generate the screens and structure for you.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Can I view individual screens in detail?">
    ...
    \
    Follow the Below Steps to View Screens:\
    \\
...
<AccordionGroup>
  <Accordion title="Can I build and run the application within Symplr?">
    ...
    **Follow the Below Steps:**\
    ...
    5. Once the build is successful, the application will run within the Symplr environment \
       \
  ...
  <Accordion title="Can I run the application on my mobile device?">
    ...
    6. The application will load and run on your device \
       \
       This allows you to test your application on a real device and verify its behavior before deployment.
  </Accordion>
  ...
  <Accordion title="Can I download the generated code?">
    ...
    7. Open the email and download the code package \
       \
       Once downloaded, you can extract the files and run the application locally using your preferred development setup.
  </Accordion>
  ...
  <Accordion title="How can I test my application?">
    ...
    - **Run within Symplr** \
      Build and run the application directly in the platform to quickly verify screens, navigation, and functionality.\
      \\
    - **Run on a mobile device** \
      Use the **Expo Go** app to scan the QR code and test the application on a real device.\
      \\
    - **Run locally using downloaded code** \
      Download the generated code, run it in an emulator, and execute automated test cases for more advanced testing.\
      \
      Choose the method that best fits your testing scenario—from quick validation to full testing with automation.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Can I apply themes to my application?">
    ...
    6. Update the values to match your desired design \
       \
       Once configured, the theme settings will be applied across your application to ensure a consistent visual style.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Why is my application not running on my device?">
    ...
    - The application has been successfully built before attempting to run it \
    \
    If the issue persists, try regenerating the QR code and scanning it again.
  </Accordion>
  ...
  <Accordion title="Why is my QR code not working?">
    ...
    - The QR code is scanned correctly using the **Expo Go** app \
    \
  ...
  <Accordion title="How do I contact support?">
    ...
    - **Report issues directly from the application** \
     When an error occurs, click the **“Report Issue”** button displayed with the error message to submit the issue instantly.\
    \
    - **Use the Help button** \
     Click the **Help** button within the application to start a chat for general questions or guidance.\
    \
    - **Email support** \
     Send an email to [**support@101digital.io**](mailto:support@101digital.io) for detailed issues or when you need to share attachments.\
    \
    Choose the option that best fits your situation for faster assistance.
  </Accordion>
