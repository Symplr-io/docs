...
<AccordionGroup>
  <Accordion title="What is Symplr used for?">
    Symplr is an AI-powered no-code platform that allows you to generate mobile and web applications without development experience. You can create applications by importing a Figma file or by using AI prompts.
  </Accordion>
