...
<AccordionGroup>
  ...
  <Accordion title="Can I run the application without downloading the code?">
    ...
    **Options:**
    ...
    - **Run within Symplr**\
      Build and run your application directly inside the platform to quickly test functionality and user flows.
    - **Run on your device using Expo Go**\
      Launch the application on your mobile device by scanning the QR code using the **Expo Go** app.

    These options allow you to validate your application quickly before downloading or deploying the code. To view step-by-step instructions, refer [here](https://docs.101studio.co/caffd#build-&-run-your-application-instantly).
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Why are some screens missing after import?">
    ...
    - Re-import it into Symplr to regenerate the Blueprint View. Refer [here](https://docs.101studio.co/untitled-page#importing-figma-files-into-symplr)
  </Accordion>
  ...
  <Accordion title="Why are some components not generated correctly?">
    ...
    - Update your Figma file
    - Re-import it into Symplr to regenerate the application. Refer [here](https://docs.101studio.co/untitled-page#importing-figma-files-into-symplr)
  </Accordion>
