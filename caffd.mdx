...
## **Quick Start — Go from Design to Application in Minutes**
...
Open your Figma design and copy the shareable file link—your gateway to instant application generation.
...
### **Run Your Application Directly in Symplr**
...
Follow the on-screen instructions to install **Expo Go**—a lightweight application for running your application on mobile devices.
