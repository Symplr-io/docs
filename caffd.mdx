...
<Info>
  ...
  - On **iOS**, use the Camera or Code Scanner. After scanning, you will be prompted to open the application in the **Expo Go** app
  - On **Android**, open the **Expo Go** app and use its built-in QR scanner

  Make sure to keep this screen open while running the application, as closing it may stop the app.
</Info>
