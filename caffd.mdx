...
In just a few steps, Symplr transforms your Figma design into a working application—ready for testing and validation.
...
Your design is transformed into a ready-to-use application blueprint.
...
Once your import is complete, Symplr instantly transforms your design into a fully structured **Blueprint View**—a visual representation of your application’s screens and navigation.
...
<Info>
  This example shows how to scan the QR code on Android. The same process applies for iOS using the Expo Go app.
</Info>
