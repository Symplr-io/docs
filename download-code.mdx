...
After downloading the generated application package, you can continue by running the application locally, configuring development environments, extending application functionality, integrating external services, and configuring authentication or deployment workflows.